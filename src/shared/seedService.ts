...
/**
 * Clears existing transaction records and seeds a comprehensive, high-fidelity default dataset 
 * (including Admin details, Menu items, Pairing rules, Discount tiers, Combo configurations, 
 * completion orders, and analytical logs) under the default 'tokyo-momos' tenant.
 * Uses repository methods to interact with the database, maintaining layered boundaries.
 * 
 * @returns An object containing counts of successfully inserted documents.
 */
export async function seedDatabase() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: 'Noodles stir-fried in rich Schezwan paste with pepper strips.',
      image: SVG_BOWL,
      price: 179,
      available: true,
      pairsWithCategories: ['Tokyo Soups', 'Tokyo Rolls'],
    ...
    },
    {
      ...
      category: 'Tokyo Rolls',
      name: 'Afghani Roll',
      description: 'Creamy cardamom chicken chunks rolled in flatbread wrapper.',
      image: SVG_ROLL,
      price: 169,
      available: true,
      pairsWithCategories: ['Tokyo Soups'],
    ...
    },
    {
      ...
      category: 'Tokyo Rolls',
      name: 'Schezwan Roll',
      description: 'Wok-tossed Schezwan chicken wrapped tightly in thin roll paratha.',
      image: SVG_ROLL,
      price: 149,
      available: true,
      pairsWithCategories: ['Tokyo Soups'],
    ...
    },
    {
      ...
      description: 'Clay oven cooked chicken tikka strips with lemon juice and red onions.',
      image: SVG_ROLL,
      price: 169,
      available: true,
      pairsWithCategories: ['Tokyo Soups'],
    ...
    },
    {
      ...
      description: 'Ultimate protein salad designed for diet plans and muscle recovery.',
      image: SVG_SALAD,
      price: 269,
      available: true,
      pairsWithCategories: [],
    ...
    },
    {
      ...
      description: 'Lean breast pieces prepared with Chinese five spices and ginger scallion sauce.',
      image: SVG_SALAD,
      price: 99,
      available: true,
      pairsWithCategories: ['Fit Meals', 'Chicken Salad'],
  ...
  await eventRepo.deleteByRestaurantId(restId);
  ...
  for (let i = 0; i < 40; i++) {
    ...
    dummyOrders.push({
      ...
      estimatedTime: 15,
      createdAt: new Date(Date.now() - (60 - i) * 60 * 60 * 1000).toISOString(),
    });
  }
  ...
  for (let i = 0; i < 10; i++) {
    ...
    dummyOrders.push({
      ...
      status: 'completed' as const,
      estimatedTime: 15,
      createdAt: new Date(Date.now() - (20 - i) * 60 * 60 * 1000).toISOString(),
    });
  }
