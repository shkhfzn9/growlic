    ...
    <div className="font-mono-custom flex flex-col gap-6">
      ...
      {orders.length === 0 ? (
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="w-full lg:w-1/2 border border-black bg-white max-h-[600px] overflow-y-auto">
          ...
          <div className="w-full lg:w-1/2 border border-black p-6 bg-white flex flex-col gap-6 sticky top-6">
            {selectedOrder ? (
              <>
                {/* Header */}
