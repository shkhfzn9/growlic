...
const SuperAdminDashboardPage = dynamic(() => import('@/features/analytics/components/SuperAdminDashboardPage'), {
  ssr: false,
  loading: () => (
    <div className="flex flex-col gap-6 w-full animate-pulse">
      <div className="h-8 w-48 bg-[#E2E6EA] rounded" />
      <div className="h-20 bg-white border border-[#E2E6EA] rounded-xl" />
