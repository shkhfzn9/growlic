...
function StampsDashboardContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#8B0000] to-[#6B0000] pb-28">
      ...
      <div className="text-center py-6 text-white/30 text-[10px] select-none font-medium flex items-center justify-center gap-1.5 mt-8 mb-2">
        <span>Powered by Growlic</span>
        <span className="bg-yellow-500/20 text-[#F5C518] border border-yellow-500/30 text-[8px] font-extrabold uppercase px-1.5 py-0.5 rounded tracking-normal">Beta</span>
      </div>
